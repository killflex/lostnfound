...
const { loading, error } = storeToRefs(authStore); // Get necessary refs from the auth store
const { login } = authStore; // Destructure the login function from the auth store
